...
import 'package:temple_mandhiram/25drmcodes/screens/singleblog.dart';
                          ...
                          child: Column(
                            children: [
                              ...
                              Padding(
                                ...
                                child: Text(controller.blogModel.value
                                        .message![index].title ??
                                    ""),
                              ),
                              const SizedBox(
                              ...
                              Row(
                                ...
                                children: [
                                  InkWell(
                                    onTap: () {
                                      controller.viewLikers(controller
                                          .blogModel.value.message![index].id!);
                                    },
                                    child: Padding(
                                      padding: const EdgeInsets.symmetric(
                              ...
                              Row(
                                ...
                                children: [
                                  ...
                                  InkWell(
                                    onTap: () {
                                      controller.commentsBlog(controller
                                          .blogModel.value.message![index].id!);
                                    },
                                    child: Container(
                                      width: width * 0.3,
                                  ...
                                  InkWell(
                                    onTap: () {
                                      Share.share(
                                          "${controller.blogModel.value.message![index].title!}\n${controller.blogModel.value.message![index].image!} ",
                                          subject: controller.blogModel.value
                                              .message![index].title!);
                                    },
                                    child: Container(
                                      width: width * 0.3,
